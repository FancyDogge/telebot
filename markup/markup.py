...
class Keyboards:
    ...
    def start_menu(self):
        ...
        """
        # ТАК КНОПКАМ ПРИПИСЫВАЮТСЯ ЗНАЧЕНИЯ, где потом сравниваются в handler all text
    ...
    def category_menu(self):
        ...
        self.markup.add(self.set_btn('QUICKSHIT'))
    ...
    def set_inline_btn(name):
        ...
        return InlineKeyboardButton(str(name),
                                    # обратный вызов
                                    # потому что необходимо ловить id каждого товара
    ...
    def set_select_category(self, category):
        ...
        # в цикле на каждый итем из выбранной категории делаем из него кнопку
